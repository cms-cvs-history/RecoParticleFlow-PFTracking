...
# not needed after making the gsf - conv brem map in advance (AA)
...
#add the gsftrack - conv tracks map (AA)
    GsfTrackToBremConvTracksMapTag = cms.InputTag("convBremGsfTrackMap"),
