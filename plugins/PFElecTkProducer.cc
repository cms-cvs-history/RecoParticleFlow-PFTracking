...
/*
// This method is deprecated for the case when we store the ctf track matched to
// the gsf one in gsfExtra (AA)
...
//bool ->geographicalId())&&
    ...
    std::cout << "Best matches: " << ibest <<std::endl;
